...
//         //         // Vector3 wheelPos = wheel.collider.transform.position;
//         //         // float slipMagnitude = wheel.wheelSlipData.normalizedSlip * 0.3f;
                
//         //         // // 根据打滑程度改变颜色
//         //         // Gizmos.color = Color.Lerp(Color.green, Color.red, wheel.wheelSlipData.normalizedSlip);
//         //         // Gizmos.DrawSphere(wheelPos, 0.1f + slipMagnitude);
